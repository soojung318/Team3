...
- `date` : 매물 등록일
```
{"_id":{"$oid":"6675339f7388ff6ebbca10"},"title":"서초아파트","address":"서초구","price":"40억","num":"02-355-6636","size":"456.45","date":"2024-06-22"}
{"_id":{"$oid":"6675391dbee80fb1719735"},"title":"서초아파트","address":"서초구","price":"30억","num":"02-255-9888","size":"159.58","date":"2024-06-22"}
```
## 👻에러 상황
### Err 1 : IP 주소 접속 권한
```
...
|이름|내용|
|:---:|-----|
|신수정| 수업을 들으며 예제코드를 따라 하다가 직접 팀원과 함께 처음부터 시도해보니 이미 알고 있다고 생각했던 부분인데 모르는 부분들을 마주하고, 생각치 못했던 에러 상황들을 접하면서 더 많은 것들을 배울 수 있었던 정말 뜻 깊은 프로젝트였습니다.|
