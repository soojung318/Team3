...
app.post("/edit", function (req, res) {
  ...
  mydb
    .collection("realestate")
    .updateOne({ _id: req.body.id }, { $set: { title: req.body.title, address: req.body.address, price: req.body.price, size: req.body.size, num: req.body.num, date: req.body.someDate } }) //updateOne({조건},{변경항목})
    .then((result) => {
      console.log("수정완료");
      res.redirect('/list');
    })
